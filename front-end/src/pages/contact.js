        ...
        <div className="grid lg:grid-cols-2 grid-cols-1 gap-x-24">
            <div className="flex items-center lg:mb-0 mb-10">
                <div className="mt-16">
                    ...
                    <form action="">
                        <input type="text" className="w-full h-14 shadow-sm text-gray-600 placeholder-text-400 text-lg font-normal rounded-full border-black py-2 px-4 mb-8" placeholder="Name" />
                        <input type="email" className="w-full h-14 shadow-sm text-gray-600 placeholder-text-400 text-lg font-normal leading-7 rounded-full border border-black focus:outline-none py-2 px-4 mb-8" placeholder="Email" required/>
                        <textarea name="" id="text" className="w-full h-48 shadow-sm resize-none text-gray-600 placeholder-text-400 text-lg font-normal leading-7 rounded-2xl border border-black focus:outline-none px-4 py-4 mb-8" placeholder="Your Message"></textarea>
                    <button className="w-full h-12 text-center text-white text-base font-semibold leading-6 rounded-full bg-black shadow transition-all duration-700 hover:bg-orange-400">Submit</button>
                    </form>
                </div>
            </div>
            <div className="lg:max-w-xl mt-10 w- h-[500px] bg-[url('https://www.searchenginejournal.com/wp-content/uploads/2022/08/contact-us-2-62fa2cc2edbaf-sej.png')] flex items-center justify-center bg-cov bg-no-repeat">
                <div className="">
